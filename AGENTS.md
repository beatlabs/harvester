...
This project is indexed by GitNexus as **harvester** (896 symbols, 2247 relationships, 32 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
