module github.com/taxibeat/harvester
...
require (
	...
	github.com/aliyun/alibaba-cloud-sdk-go v0.0.0-20190409093201-1ca5692ba788 // indirect
	...
	github.com/hashicorp/nomad/api v0.0.0-20190409014210-ca9b27e9db8f // indirect
